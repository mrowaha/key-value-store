...
void get_dataset_idx(const dataset_mng *, const int dataset, index_list *idxlist);

void get_value_by_offset(const dataset_mng *, const int dataset, int offset, char value[], int *key);
